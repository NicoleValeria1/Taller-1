...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar qué país representa un atleta");
	...
	{
		System.out.println("\n" + "A qué país pertenece un atleta" + "\n");

		String atleta = input("Ingrese el nombre del atleta de su interés");
		Pais pais = calculadora.atletaporPais(atleta);
		System.out.println("El atleta representa a " + pais);
